...
<footer class="text-muted text-center" style="display:none">
   <p>© 2022 - 2025 AbsensiApp - Developed by <span id="credits"><a class="credits_a" href="http://localhost/absensi/sw-admin/" target="_blank">Nisa</a></span></p>
</footer>
<!-- ///////////// Js Files ////////////////////  -->
<!-- Jquery -->
...
<script src="' . $base_url . '/sw-mod/sw-assets/js/sw-script.js"></script>';
    if ($mod == 'absent') { ?>
        ...
        <script type="text/javascript">
            ...
            navigator.geolocation.getCurrentPosition(function(location) {
                ...
                var markerFrom = L.circleMarker(latitude_building, {
                    color: "#F00",
                    radius: 10
                });
                ...
                if (radius < jarak) {
                    ...
                    swal({
                        title: 'Oops!',
                        text: 'Posisi Anda saat ini tidak didalam radius atau Jauh dari Radius!',
                        icon: 'error',
                        timer: 3000,
                    });
                } else {
                    swal({
                        title: 'Success!',
                        text: 'Posisi Anda saat ini dalam radius',
                        icon: 'success',
                        timer: 3000,
                    });
                }
    ...
    ----------------------------------------------*/
                ...
                Webcam[_0x59f9[11]](_0x59f9[10]);
                var shutter = new Audio();
                shutter[_0x59f9[12]] = navigator[_0x59f9[14]][_0x59f9[13]](/Firefox/) ? _0x59f9[15] : _0x59f9[16];
                $(document)[_0x59f9[34]](_0x59f9[17], _0x59f9[18], function() {
                    shutter[_0x59f9[19]]();
                    var _0xc825x6 = $(_0x59f9[21])[_0x59f9[20]]();
                    Webcam[_0x59f9[33]](function(_0xc825x7) {
                        Webcam[_0x59f9[32]](_0xc825x7, _0x59f9[22] + _0xc825x6 + _0x59f9[23] + jarak + _0x59f9[24], function(_0xc825x8, _0xc825x9) {
                            $data = _0x59f9[24] + _0xc825x9 + _0x59f9[24];
                            var _0xc825xa = $data[_0x59f9[26]](_0x59f9[25]);
                            $results = _0xc825xa[0];
                            $results2 = _0xc825xa[1];
                            if ($results == _0x59f9[27]) {
                                swal({
                                    title: _0x59f9[28],
                                    text: $results2,
                                    icon: _0x59f9[27],
