      ...
      echo '
          ...
          <center>
            <table class="table" style="margin-top:90px;border:0px;padding:10px;width:100%">
              <tbody>
                <tr>
                  <td class="text-center" valign="top" width="40%">Mengetahui,Pengguna Anggaran<p class="name-ttd"><span style="text-decoration: underline;">Dr. KIKIM ADE IRAWAN, MARS</span><br>NIP. 19819828 200902 1 001</p></td>
                  
                  <td class="text-center" valign="top">Indramayu, ' . tgl_indo($date) . '<br>PPTK<p class="name-ttd"><span style="text-decoration: underline;">YUDHI IMRON ROSYADI, SE, M.Pd</span><br>NIP. 19770413 200902 1 001</p></td>
                </tr>
              </tbody>
            </table>
          </center>
